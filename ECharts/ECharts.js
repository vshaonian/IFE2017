					...
					function(module, exports, __webpack_require__) {
							...
							echarts.init = function(dom, theme, opts) {
								if (true) {
									...
									if ((zrender.version.replace('.', '') - 0) < (echarts.dependencies.zrender.replace('.', '') - 0)) {
										throw new Error(
											'ZRender ' + zrender.version + ' is too old for ECharts ' + echarts.version + '. Current version need ZRender ' + echarts.dependencies.zrender + '+'
										);
									}
									if (!dom) {
						...
						function(module, exports, __webpack_require__) {
							...
							var GlobalModel = Model.extend({
								...
								setOption: function(option, optionPreprocessorFuncs) {
									zrUtil.assert(!(OPTION_INNER_KEY in option),
								...
								mergeOption: function(newOption) {
									...
									// FIXME OPTION åŒæ­¥æ˜¯å¦è¦æ”¹å›žåŽŸæ¥çš„
						...
						function(module, exports, __webpack_require__) {
							...
							modelUtil.makeIdAndName = function(mapResult) {
								...
								each(mapResult, function(item, index) {
									...
									zrUtil.assert(!opt || opt.id == null || !idMap[opt.id] || idMap[opt.id] === item,
						...
						function(module, exports, __webpack_require__) {
							...
							Model.prototype = {
								...
								get: function(path, ignoreParent) {
									...
									return doGet(
										this.option,
										this.parsePath(path), !ignoreParent && getParent(this, path)
									);
								},
								...
								getModel: function(path, parentModel) {
									...
									parentModel = parentModel || (
										(thisParentModel = getParent(this, path)) && thisParentModel.getModel(path)
									);
								...
								RootClass.extend = function(proto) {
									...
									if (true) {
										zrUtil.each(mandatoryMethods, function(method) {
											if (!proto[method]) {
												console.warn(
													'Method `' + method + '` should be implemented' + (proto.type ? ' in ' + proto.type : '') + '.'
												);
											}
										});
									}
								...
								_updateAndAddDisplayable: function(el, clipPaths, includeIgnore) {
									...
									if (userSetClipPath) {
										...
										while (currentClipPath) {
											// clipPath çš„å˜æ¢æ˜¯åŸºäºŽä½¿ç”¨è¿™ä¸ª clipPath çš„å…ƒç´ 
						...
						function(module, exports) {
							...
							module.exports = (typeof window !== 'undefined' &&
								(window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame)) || function(func) {
								setTimeout(func, 16);
							};
							...
							Painter.prototype = {
								...
								insertLayer: function(zlevel, layer) {
									...
									if (len > 0 && zlevel > zlevelList[0]) {
										for (i = 0; i < len - 1; i++) {
											if (
												zlevelList[i] < zlevel && zlevelList[i + 1] > zlevel
											) {
												break;
											}
										}
								...
								_getSize: function(whIdx) {
									...
									return (
										(root[cwh] || parseInt10(stl[wh]) || parseInt10(root.style[wh])) - (parseInt10(stl[plt]) || 0) - (parseInt10(stl[prb]) || 0)
									) | 0;
								},
								...
								listProto.initData = function(data, nameList, dimValueGetter) {
									...
									dimValueGetter = dimValueGetter || function(dataItem, dimName, dataIndex, dimIndex) {
										...
										return modelUtil.converDataValue(
											(value instanceof Array) ? value[dimIndex]
							...
							gridProto._initCartesian = function(gridModel, ecModel, api) {
								...
								function createAxisCreator(axisType) {
									return function(axisModel, idx) {
										...
										var axis = new Axis2D(
											axisType, axisHelper.createScaleByModel(axisModel), [0, 0],
											axisModel.get('type'),
											axisPosition
										);
						...
						function(module, exports, __webpack_require__) {
							...
							var builders = {
								...
								axisName: function() {
									...
									var pos = [
										nameLocation === 'start' ? extent[0] - gapSignal * gap : nameLocation === 'end' ? extent[1] + gapSignal * gap : (extent[0] + extent[1]) / 2, // 'middle'
										// Reuse labelOffset.
									...
									var truncatedText = (ellipsis != null && maxWidth != null) ? formatUtil.truncateText(
						...
						function(module, exports, __webpack_require__) {
							...
							function adjustSingleSide(list, cx, cy, r, dir, viewWidth, viewHeight) {
								...
								function changeX(list, isDownList, cx, cy, r, dir) {
									var lastDeltaX = dir > 0 ? isDownList // å³ä¾§
										? Number.MAX_VALUE // ä¸‹
										: 0 // ä¸Š
										: isDownList // å·¦ä¾§
										? Number.MAX_VALUE // ä¸‹
									...
									for (var i = 0, l = list.length; i < l; i++) {
										...
										var deltaX = (deltaY < r + length) ? Math.sqrt(
											(r + length + length2) * (r + length + length2) - deltaY * deltaY
						...
						function(module, exports, __webpack_require__) {
							...
							__webpack_require__(1).extendChartView({
								...
								render: function(seriesModel, ecModel, api) {
									...
									group.remove(
										symbolDraw === largeSymbolDraw ? normalSymbolDraw.group : largeSymbolDraw.group
									);
								},
						...
						function(module, exports, __webpack_require__) {
							...
							function doConvert(methodName, ecModel, finder, value) {
								...
								var coordSys = geoModel ? geoModel.coordinateSystem : seriesModel ? (
